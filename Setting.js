...
global.location  = 'ChChiniot, Pakistan' ;
...
global.owner = process.env.OWNER_NUMBER  || '923472207399' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923472207399" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"💙𓆩‎✘𝐀𝐌𝐄𝐄𝐑-𝐌𝐔𝐀𝐖𝐈𝐘𝐀𓆪_✰",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
global.gurl  = 'https://chat.whatsapp.com/JnbtAi0Mb10JNTyOfXtB0h' ; 
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://i.ibb.co/Cb81NxN/251.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '12_07_2024_SIGMA_MD_supdMAai_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || '𝐀𝐌𝐄𝐄𝐑 𝐌𝐔𝐀𝐖𝐈𝐘𝐀',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𝐀𝐌𝐄𝐄𝐑 𝐌𝐔𝐀𝐖𝐈𝐘𝐀`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝐀𝐌𝐄𝐄𝐑 𝐌𝐔𝐀𝐖𝐈𝐘𝐀',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝐀𝐌𝐄𝐄𝐑 𝐌𝐔𝐀𝐖𝐈𝐘𝐀" ,          // ADD YOUR STICKER PACKNAME
  ...
  antibadwords_values: process.env.ANTI_BAD_WORDS || 'Fuck,porn,sex,xxx,fucker,asshole,fuck you,xxnx,sexy,hot girl,fuck off',   // IT WILL TAKES ACTIONS WHO SENDS THESE BAD WORDS
